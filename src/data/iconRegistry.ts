...
export const iconRegistry: IconDefinition[] = [
  ...
  { id: 'sunflower', label: 'ひまわり', aliases: ['ひまわり','向日葵','sunflower'], svg: svg('M50 8 L58 28 L78 18 L72 40 L94 45 L74 56 L88 76 L64 71 L59 93 L49 73 L30 88 L36 65 L12 61 L34 49 L18 30 L42 35 Z M50 37 A18 18 0 1 0 50.1 37 Z'), printability: 'caution', ...meta },
